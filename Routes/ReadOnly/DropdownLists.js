...
const getSubTypeListWithId = db.rawDataQuery('SELECT SubTypeId, Name FROM SubType WHERE TypeId=$1',['typeId'])
const getAreaListWithId = db.rawDataQuery('SELECT AreaId, Name FROM Area WHERE CountryId=$1',['countryId'])
