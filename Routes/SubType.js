...
const getAllSubTypesWithTypeName = db.rawDataSimpleQuery(`
SELECT S.SubTypeId, S.Name, T.TypeId, T.Name as TypeName 
FROM SubType S join Type T on S.typeId=T.TypeId`)
